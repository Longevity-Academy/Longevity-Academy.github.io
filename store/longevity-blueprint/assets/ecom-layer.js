/* =====================================================================
   ...
   Powers the mechanics of the funnel narrative that lives in index.html:
     · live countdown to the Aug 17, 2026 founder cohort (deterministic)
...
(function () {
  ...
  var COHORT_ISO = '2026-08-17T00:00:00-04:00';   // real cohort start
  ...
  var engaged = false;
  setTimeout(function () { engaged = true; }, 12000);
    ...
    a.addEventListener('click', function () {
      try {
        ...
        window.dataLayer.push({
          ...
          value: 289, currency: 'USD', item_name: 'The Longevity Blueprint'
        });
      } catch (e) {}
    });
  });
